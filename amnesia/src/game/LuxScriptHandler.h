...
private:
	...
	*/
	...
	static void __stdcall SetLantern(int alLanternNum);
	static int __stdcall GetLantern();
	static void __stdcall SetArm(int alArmNum);
	static int __stdcall GetArm(int alArmNum);
	...
	*/
	...
	static void __stdcall RemoveNote(string& asEntryName);
