...
void cLuxPlayerHands_SaveData::FromPlayerHands(cLuxPlayerHands *apPlayerHands)
{
	...
	mlActiveHand = apPlayerHands->mlActiveHand;
}
...
void cLuxPlayerHands_SaveData::ToPlayerHands(cLuxMap *apMap, cLuxPlayerHands *apPlayerHands)
{
	...
	//HPL jank be like
	apPlayerHands->UpdateHandModel(mlActiveHand, apMap);
...
kSerializeVar(mlActiveHand, eSerializeType_Int32)
kEndSerialize()
...
void cLuxPlayer_SaveData::FromPlayer(cLuxPlayer *apPlayer)
{
	...
	mbLanternEquipped = apPlayer->GetHelperLantern()->lanternNum;
...
void cLuxPlayer_SaveData::ToPlayer(cLuxMap *apMap,cLuxPlayer *apPlayer)
{
	...
	apPlayer->GetHelperLantern()->lanternNum = mbLanternEquipped;
...
kSerializeVar(mbLanternEquipped, eSerializeType_Int32)
