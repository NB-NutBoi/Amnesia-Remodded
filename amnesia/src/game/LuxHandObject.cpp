...
void iLuxHandObject::LoadSettings(cXmlElement *apVarsElem)
{
	...
	msLanternOffSoundS = apVarsElem->GetAttributeString("LanternOffSound", "ui_lantern_off");
	msLanternOnSoundS = apVarsElem->GetAttributeString("LanternOnSound", "ui_lantern_on");
	msLanternOutOfOilSoundS = apVarsElem->GetAttributeString("LanternNoOilSound", "ui_lantern_off");

	gpBase->mpEngine->GetResources()->GetSoundEntityManager()->Preload(msLanternOffSoundS);
	gpBase->mpEngine->GetResources()->GetSoundEntityManager()->Preload(msLanternOnSoundS);
	gpBase->mpEngine->GetResources()->GetSoundEntityManager()->Preload(msLanternOutOfOilSoundS);
