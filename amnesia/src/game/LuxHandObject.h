...
public:	
	...
	const tString& GetOffSound() { return msLanternOffSoundS; }
	const tString& GetOnSound() { return msLanternOnSoundS; }
	const tString& GetNoOilSound() { return msLanternOutOfOilSoundS; }

	tString msLanternOnSoundS;
	tString msLanternOffSoundS;
	tString msLanternOutOfOilSoundS;
